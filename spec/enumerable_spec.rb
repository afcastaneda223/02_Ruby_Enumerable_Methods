...
describe Enumerable do
  ...
  describe '#my_count' do
    ...
    it 'when block is given but without argument' do
      expect(array.my_count { |x| x > 3 }).to eq(1)
    end
  end
  ...
  describe '#my_inject' do
    ...
    it 'when symbol is given' do
      expect(array.my_inject(:+)).to eq(45)
    end

    it 'when block is given' do
      expect(array.my_inject { |sum, n| sum + n }).to eq(45)
    end

    it 'when block and argument are given' do
      expect(array.my_inject(1) { |product, n| product * n }).to eq(151_200)
    end
  end
end
